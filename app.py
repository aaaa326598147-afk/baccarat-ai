...
st.markdown(
    ...
    .bet-label-white {{
        ...
        display: inline-block; /* 配合父層 text-align center 達成置中 */
...
# --- 4. 【注碼中心：移除多餘框 + 標籤置中修正】 ---
st.markdown('<div class="bet-label-container">', unsafe_allow_html=True)
